...
const Navbar = () => {
  return (
    <nav
      className={`font-RobotoSerif flex justify-center left-[50%] translate-x-[-50%] bg-[linear-gradient(180deg_#FFFFFF_0%_rgba(255 245 245 0.5)_100%)] absolute  p-[10px] text-[21px] font-[400] items-center mt-[20px] h-[65px] w-[222px] rounded-[20px] shadow-[0_4px_40px_rgba(74,74,74,0.05)] bg-[#F6F6F6]`}
    >
      <div>
