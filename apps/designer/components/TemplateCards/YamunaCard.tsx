...
const YamunaCard = () => {
  return (
    <div className="  h-[364px] md:static fixed z-1 bg-white  w-[220px] md:mt-0 mt-[95px] border-[1px]  items-center py-[10px]  flex flex-col border-zinc-300 shadow-[0px_4px_40px_rgba(0_0_0_0.15)] rounded-[15px]">
