  ...
  return window.innerWidth < 768 && isWelcomePanelActive === true ? (
    ...
    <>
      <div
        ...
        // }}
        className={`
          z-[100] relative font-Roboto flex items-center flex-col mt-2.5   justify-center   w-[80vw] mx-auto sm:w-[250px] ease-in-out duration-500 md:w-[27vw] h-[76vh]  rounded-[20px]  
          ${
            !isWelcomePanelActive
