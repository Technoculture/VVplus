...
const FloorSlider = () => {
  return (
    <div className="text-white lg:text-sm text-xs relative lg:left-[70.5%] md:left-[72.5%] border-2 border-amber-100 items-center flex rounded-2xl z-[100]  mt-2 bg-black bg-opacity-40 h-[5vh] w-[23vw] lg:w-[27vw] font-[Roboto]">
