...
const FloorSlider = () => {
  return (
    <div className="text-white lg:text-sm text-xs relative left-[69%] border-2 border-white items-center flex rounded-2xl z-[100]  mt-2 bg-black bg-opacity-40 h-[5vh] w-[26vw] font-[Roboto]">
